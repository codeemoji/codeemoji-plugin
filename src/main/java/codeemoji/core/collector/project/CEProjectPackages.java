...
permits CEProjectMethodCollector{
    ...
    @Override
    default void processStructuralAnalysisFR(@NotNull CERuleElement ruleElement, @NotNull CERuleFeature ruleFeature, @NotNull PsiPackageStatement structuralAnalysisFeatureElement, @NotNull A addHintElement, @NotNull InlayHintsSink sink, @NotNull CESymbol symbol, @NotNull String keyTooltip) {
