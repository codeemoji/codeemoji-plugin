...
public class InFrequentlyModifiedConfigurable extends CEBaseConfigurableWindow<InFrequentlyModifiedSettings> {

    @Override
    protected void buildForm(FormBuilder builder, InFrequentlyModifiedSettings settings, @Nullable String preview, Project project, Language language, ChangeListener changeListener) {
