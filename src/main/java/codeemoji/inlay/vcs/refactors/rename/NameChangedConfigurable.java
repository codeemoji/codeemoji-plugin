...
public class NameChangedConfigurable extends CEBaseConfigurableWindow<NameChangedSettings> {


    @Override
    protected void buildForm(FormBuilder builder, NameChangedSettings settings, @Nullable String preview,
